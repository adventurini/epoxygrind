...
spaceType (string — a short natural-language phrase like "Two-car garage" or "Commercial warehouse floor", never snake_case or an enum), conditionNotes (string), surfaceIssues (string[]), recommendedFinish ("solid"|"flake"|"metallic"),
