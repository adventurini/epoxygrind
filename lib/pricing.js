...
//
// Flake re-tightened 2026-07-14: still coming in too high in practice even
// after the above. Re-checked 10 real 2026 sources (Angi, HomeGuide,
// ArmorGarage, Homewyse, Bhumi, TN Garage Floor Coatings, Rose Restoration,
// Everlast, plus FL/NJ region-specific guides) — they converge tightly on
// $6-9/sqft installed for a *typical* residential flake job; the wider
// $3-12 figure some sites lead with is the outlier range (complex jobs,
// premium coastal metros), not the norm a default estimate should center
// on. Real regional premiums run ~15-30% above national average in
// high-cost coastal metros (CA, NY, DC/VA/MD, SE Florida) and correspondingly
// below in lower-cost inland/rural markets — that's what
// lib/market-pricing.js's AI locale lookup is *for*; this baseline is the
// national-typical center it should be varying around, not the ceiling
// it was drifting toward regardless of actual location.
