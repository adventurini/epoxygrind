...
export async function generateSlideScenes({ audience, topic }) {
  ...
  const closerNote = audience === 'consumer'
    ...
    : '6. Closer slide — this one is NOT about marketing/ops anymore, and Grinder Dad is NOT working and NOT holding any tool, grinder, or equipment of any kind. He is relaxed and delighted, standing or sitting on his own gleaming, glossy, flawless finished floor — arms crossed with a big grin, a thumbs up, or lounging back enjoying it, empty-handed. This is the customer enjoying the result, not a tradesman on the job — no tools anywhere in frame.';
