// Cross-origin allowlist for client-site demos that embed EpoxyGrind's own
// estimator against our live API instead of duplicating it — currently just
// the Mirrorball Epoxy demo build (own repo/hosting, see
// mirrorball-epoxy on GitHub). Exact origins for the production alias plus
// a prefix match for Vercel's per-deploy preview URLs
// (mirrorball-epoxy-<hash>-<team>.vercel.app), since those hashes aren't
// predictable ahead of a deploy. Deliberately NOT a wildcard — this is a
// named allowlist of sites we've built, not "any origin may call this."
...
const ALLOWED_ORIGIN_PREFIXES = ['https://mirrorball-epoxy-'];
